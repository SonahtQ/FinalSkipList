...
//
export default class FinalSkipList {
    ...
    constructor(...args) {
        ...
        //
        this.#head = new Node(Number.NEGATIVE_INFINITY, null, this.#config.maxLevel);
        this.#tail = new Node(Number.POSITIVE_INFINITY, null, this.#config.maxLevel);
    ...
    insert(value, score, fromTail = false) {
        ...
        const newNode = new Node(score, value, newNodeLevel);
